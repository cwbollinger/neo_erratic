...
int player_pointcloud3d_stereo_element_pack(void* buf, size_t buflen, player_pointcloud3d_stereo_element_t * msg, int op);
...
int player_stereo_data_pack(void* buf, size_t buflen, player_stereo_data_t * msg, int op);
